...
def is_image_file(filename):
    return any(filename.endswitch(extension) for extension in IMG_EXTENSIONS)
...
class MaskBaseDataset(data.Dataset):
    ...
    _file_names = {
        "mask1": MaskLabels.maks,
        "mask2": MaskLabels.maks,
        "mask3": MaskLabels.maks,
        "mask4": MaskLabels.maks,
        "mask5": MaskLabels.maks,
    ...
    def setup(self):
        ...
        for profile in profiles:
            ...
            for file_name in os.listdir(img_folder):
                ...
                if _file_name not in self._file_names: # invalid 한 파일들은 무시합니다.
                    continue
                img_path = os.path.join(self.data_dir, profile, file_name) # (resized_data, 000004_male_Asian_54, mask1.jpg)
                mask_label = self._file_names[_file_name]

                id, gender, race, age = profile.split("_")
                gender_label = getattr(self.GenderLabels, gender) # self.GenderLables.gender
    ...
    def calc_statistics(self):
        ...
        if not has_statistics:
            print("[Warning] Calculating statistics... It can takes huge amounts of time depending on your CPU mashine :(")
            sums = []
            squared = []
